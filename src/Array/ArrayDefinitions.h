...
template <typename T, size_t MAX_SIZE> Array<T, MAX_SIZE>::Array() {
  size_ = 0;
}
...
template <typename T, size_t MAX_SIZE> void Array<T, MAX_SIZE>::clear() {
  size_ = 0;
}
...
template <typename T, size_t MAX_SIZE> void Array<T, MAX_SIZE>::pop_back() {
  if (size_ > 0) {
    --size_;
  }
}
...
template <typename T, size_t MAX_SIZE> size_t Array<T, MAX_SIZE>::size() const {
  return size_;
}
...
template <typename T, size_t MAX_SIZE> bool Array<T, MAX_SIZE>::empty() const {
  return size_ == 0;
}

template <typename T, size_t MAX_SIZE> bool Array<T, MAX_SIZE>::full() const {
...
template <typename T, size_t MAX_SIZE> T *Array<T, MAX_SIZE>::data() {
  return values_;
}
